...
import { getUserTransictions } from "../../actions/transictionsActions";

class ViewTransictions extends Component {
  constructor() {
    super();
    this.state = {
      user: {},
  ...
  componentDidMount() {
    if (!this.props.auth.isAuthenticated) {
      ...
      this.props.getUserTransictions(user, (err, result) => {
        if (err) {
          console.log(err);
        } else {
...
ViewTransictions.propTypes = {
  getUserTransictions: PropTypes.func.isRequired,
